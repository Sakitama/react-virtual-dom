...
var _patch = __webpack_require__(1);
...
var count = 0;
var ul = (0, _element2.default)('ul', { id: 'list' }, [(0, _element2.default)('li', { class: 'item' }, [count]), (0, _element2.default)('li', { class: 'item' }, [count + 1]), (0, _element2.default)('li', { class: 'item' }, [count + 2])]);
...
setInterval(function () {
    count++;
    var newUl = (0, _element2.default)('ul', { id: 'list' }, [(0, _element2.default)('li', { class: 'item' }, [count]), (0, _element2.default)('li', { class: 'item' }, [count + 1]), (0, _element2.default)('li', { class: 'item' }, [count + 2])]);
    var patches = (0, _diff2.default)(ul, newUl);
    ul = newUl;
    (0, _patch2.default)(dom, patches);
}, 2000);
